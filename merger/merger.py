...
class StubMerger:
    ...
    def _write_single_stub_file(
        self, path: Path, namespace: str | None, item_type: str, item: dict
    ) -> None:
        lines: list[str] = [
            "<?php",
    ...
    def _write_functions_constants_stub_file(
        self, path: Path, namespace: str | None, functions: list, constants: list
    ) -> None:
        lines: list[str] = [
            "<?php",
            f"// PocketMine-MP {self.version} stubs — generated by pocketide/pocketmine-stubs",
    ...
    def _write_namespace_files(self) -> None:
        """Agrupa por namespace y escribe archivos PHP individuales por clase/interface/trait."""
        ...
        for ns, items in ns_map.items():
            ...
            if items["functions"] or items["constants"]:
                ...
                self._write_functions_constants_stub_file(
                    path / fn_const_filename,
                    ns if ns != "__global__" else None,
                    items["functions"],
                    items["constants"],
                )
